...
public class Magazine {
    ...
    private sio.devoir2magazine.entities.Specialite numSpecialite;
    ...
    public sio.devoir2magazine.entities.Specialite getNumSpecialite() {
        return numSpecialite;
    }

    public void setNumSpecialite(sio.devoir2magazine.entities.Specialite numSpecialite) {
